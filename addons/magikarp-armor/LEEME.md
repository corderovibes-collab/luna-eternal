# Magikarp Animated Armor

Mod Fabric 1.21.1 con cuatro objetos equipables y GeckoLib 4.7.6.

La animación `animation.magikarp_armor.idle` dura 3,2 segundos y se repite:
...
```
/give @s magikarparmor:magikarp_helmet
/give @s magikarparmor:magikarp_chestplate
/give @s magikarparmor:magikarp_leggings
/give @s magikarparmor:magikarp_boots
```
